...
{
    /// <summary>
    /// Класс для определения ориентации ключевых точек и поиска дескрипторов
    /// </summary>
    public class SURFDescriptor
    {
        //Матрица коэффициентов нормального распределения с сигмой, равной 2.5
      ...
      {0.00131955648461f,0.00103799989504f,0.00069579213743f,0.00039744277546f,0.00019345616757f,0.00008024231247f,0.00002836202103f}
        ...
        /// <summary>
        /// Вычисление угла, образуемого вектором относительно оси Х
        /// </summary>
        ...
        /// <summary>
        /// Получить значение функции Гаусса в точке с указанным значением стандартного отклонения сигма
        /// </summary>
    ...
    public class SurfDescriptor
    {
      ...
      {0.00131955648461f,0.00103799989504f,0.00069579213743f,0.00039744277546f,0.00019345616757f,0.00008024231247f,0.00002836202103f}
        ...
        public static void DecribeInterestPoints(List<InterestPoint> ipts, bool upright, bool extended, IntegralImage img)
        {
            SurfDescriptor des = new SurfDescriptor();
        ...
        /// <param name="ipts"></param>
        /// <param name="upright"></param>
        public void DescribeInterestPoints(List<InterestPoint> ipts, bool upright, bool extended, IntegralImage img)
        {
            if (ipts.Count == 0) return;
            this.img = img;

            foreach (InterestPoint ip in ipts)
            {
        ...
        void GetDescriptor(InterestPoint ip, bool bUpright, bool bExtended)
        {
            int sample_x, sample_y, count = 0;
            int i = 0, ix = 0, j = 0, jx = 0, xs = 0, ys = 0;
            float dx, dy, mdx, mdy, co, si;
